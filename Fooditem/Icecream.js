...
const data = [
  {
    id: 1,
    img: { uri: 'https://greenbowl2soul.com/wp-content/uploads/2019/11/veg-Icecream-500x375.jpg' },
    name: 'Veg Icecream',
    price:'50'
  },
  {
  ...
  return (
    <View style={styles.container}>
      <View style={{ flex: 0.75, backgroundColor: 'red' }}>
        <ImageBackground source={{ uri: 'https://image.freepik.com/free-vector/engraving-hand-drawn-ice-cream-blackboard-background_23-2148974965.jpg' }} style={{ height: '100%', width: '100%',opacity:0.95,}} resizeMode='cover'>  
